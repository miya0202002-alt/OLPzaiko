...
<style>
    ...
    .header-box {
        ...
        color: white;
        font-weight: bold;
        font-size: 10px !important; /* ★ここを小さくしました */
        text-align: center;
        padding: 6px 1px !important; /* ★余白も詰めました */
        border-radius: 4px;
        height: 100%;
        display: flex;
        align-items: center;
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(f"<div class='panel-info'>選択中: <b>{display_name}</b></div>", unsafe_allow_html=True)
